...
const LoginSignupLayout = () => {
  ...
  return (
    <div className="fixed top-0 left-0 z-20 md:p-6 h-dvh w-dvw bg-gray-950/20 flex items-center justify-center ">
      <div className="max-w-screen-md mx-auto flex rounded-2xl overflow-hidden shadow-input">
        <div className="bg-blue-400 hidden md:block relative">
          <div className="absolute top-0 left-0 w-full h-full flex items-center justify-between flex-col gap-4 p-8">
            ...
            <div className="flex flex-col gap-1 grow text-lg font-medium text-slate-900">
              {
                features.map((feature, index) => <span key={index}>
