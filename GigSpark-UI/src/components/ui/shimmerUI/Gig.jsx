            ...
            <div className="h-full ">
              <div className="p-6">
                ...
                <div className="flex items-center flex-wrap ">
                  <span className="bg-indigo-300 h-6 animate-pulse mt-2 w-32 inline-flex items-center md:mb-2 lg:mb-0"></span>
                  <span className="bg-indigo-300 w-16 mt-2 h-6 animate-pulse mr-3 px-2 inline-flex items-center ml-auto leading-none text-sm pr-5 py-1"></span>
                </div>
              </div>
            </div>
        </aside>
